...
*>python pCRMeval.py -nameOfmet SCRMshaw -fullredfly allredfly2020_2kb.txt -subsetcrmsExpBed redfly-analysis-set.assignmentBED_oldNewMixAug20.bed -finalcrmsExp redfly-analysis-set.assignmentList_OldNewMix.txt -tsetBedOrList list -listTset trainingset_OldNewMix_Aug20.txt -e exons.bed -drosog genome_chr_lengths_r6_copy.txt -so scrmshawOutput_peaksCalledover5kcrms_allSets_IMM.bed  -cont False -goodHits False -p 35000 -s 10 -pattern True -o output* 
